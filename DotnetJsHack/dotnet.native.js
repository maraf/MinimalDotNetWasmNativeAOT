...
// end include: preamble.js
  ...
  /** @type {function(...*):?} */
  function _NativeRuntimeEventSource_LogExceptionThrown(
  ) {
  abort('missing function: NativeRuntimeEventSource_LogExceptionThrown');
  }
  _NativeRuntimeEventSource_LogExceptionThrown.stub = true;
  ...
  var DOTNET = {
  setup:function setup(linkerSetup) {
...
DOTNET.setup({ linkerDisableLegacyJsInterop: false,linkerWasmEnableSIMD: true,linkerWasmEnableEH: true,linkerEnableAotProfiler: false, linkerEnableBrowserProfiler: false, linkerRunAOTCompilation: false, gitHash: "987fcce1c98c81c476fbff25024d62dbe3ffd85b", });;
function checkIncomingModuleAPI() {
  ignoredModuleProp('fetchSettings');
}
var wasmImports = {
  /** @export */
  NativeRuntimeEventSource_LogExceptionThrown: _NativeRuntimeEventSource_LogExceptionThrown,
  /** @export */
...
var ___Module__DATA = Module['___Module__DATA'] = 484908;
